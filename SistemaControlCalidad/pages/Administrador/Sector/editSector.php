									...
									<?php
										echo "<form role=\"form\" method=\"POST\" action=\"accionesUS/edit.php?idArray=".$idArray."\">
											<div class=\"form-group\">
												...
												<input class=\"form-control\" name=\"nameSector\" required=\"true\" placeholder=\"Nombre de Sector\">
											</div>";
											
										echo	"<div class=\"form-group\">
                                            <label>Seleccione Huerto al que Pertence</label>
                                            <select class=\"form-control\" name=\"nameHuerto\">";
                                        ...
                                        echo   
											"<button type=\"submit\" class=\"btn btn-primary\">Editar Huerto</button>
