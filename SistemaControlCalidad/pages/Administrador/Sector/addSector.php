<?php
	...
	$command = "python ../../../../ControlDeCalidad/Modules/CCampos/handlerSector.py 2";
	$output = array();
	...
	$command = "python ../../../../ControlDeCalidad/Modules/CCampos/handlerSector.py 3";
	$output2 = array();
	exec($command, $output2);#ejecucion del comando
	$numberUser2 = count($output2);
            ...
            <ul class="nav navbar-top-links navbar-right">
                ...
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu dropdown-user">
                        ...
                        <li class="divider"></li>
                        <li><a href="Sector.php"><i class="fa fa-sign-out fa-fw"></i>Volver atrás</a>
                        </li>
                    ...
                    <ul class="nav" id="side-menu">
                        ...
                        <li>
                            ...
                            <ul class="nav nav-second-level">
                                ...
                                <li>
                                    <a href="Sector.php">Configuración de Sector</a>
                                </li>
                                <li>
                                ...
                                <div class="col-lg-6">
                                    <form role="form" method="POST" action="accionesUS/add.php">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" name="nameSector" required="true" placeholder="Nombre del Sector">
                                        </div>
                                        
                                        <div class="form-group">
                                            <label>Seleccione Huerto al que Pertence</label>
                                            <select class="form-control" name="huerto">
												<?php
													for ($i=0; $i<$numberUser2; $i++){
														echo "<option>".$output2[$i]."</option>";
													}
												?>
