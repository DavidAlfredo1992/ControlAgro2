<?php
	...
	$command = "python ../../../../ControlDeCalidad/Modules/CCampos/handlerCuartel.py 4";
	$output3 = array();
	exec($command, $output3);#ejecucion del comando
	$numberUser3 = count($output3);
	
	#obtener las variedades para asociarlas al cuartel
	$command = "python ../../../../ControlDeCalidad/Modules/CCampos/handlerCuartel.py 8";
	$output = array();
            ...
            <ul class="nav navbar-top-links navbar-right">
                ...
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu dropdown-user">
                        ...
                        <li class="divider"></li>
                        <li><a href="Cuartel.php"><i class="fa fa-sign-out fa-fw"></i>Volver atrás</a>
                        </li>
                    ...
                    <ul class="nav" id="side-menu">
                        ...
                        <li>
                            ...
                            <ul class="nav nav-second-level">
                                ...
                                <li>
                                    <a href="../HuertoHuerto.php">Configuración de Huerto</a>
                                </li>
                                <li>
                                    <a href="../Sector/Sector.php">Configuración de Sector</a>
                                </li>
                                <li>
                                    <a href="Cuartel.php">Configuración de Cuartel</a>
                                </li>
                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            Ingreso de Nuevo Cuartel
                        </div>
                        <div class="panel-body">
                            <div class="row">
                                <div class="col-lg-6">
                                    <form role="form" method="POST" action="accionesUS/add.php">
                                        <div class="form-group">
                                            <label>Nombre del Cuartel</label>
                                            <input class="form-control" name="nameCuartel" required="true" placeholder="Nombre del Cuartel">
                                        </div>
                                        
                                        <div class="form-group">
                                            <label>Seleccione Sector al que Pertence</label>
                                            <select class="form-control" name="sector">
												<?php
													for ($i=0; $i<$numberUser3; $i++){
														echo "<option>".$output3[$i]."</option>";
													}
												?>
										 ...
										 <div class="form-group">
                                            <label>Selecciona las Variedades</label>
                                            <p class="help-block">Pulsando la tecla control puedes seleccionar más de una</p>
                                            <select multiple class="form-control" name="variedad[]" required="true">
                                        ...
                                        <button type="submit" class="btn btn-primary">Agregar Cuartel</button>
