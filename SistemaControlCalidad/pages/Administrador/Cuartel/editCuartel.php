									...
									<?php
										echo "<form role=\"form\" method=\"POST\" action=\"accionesUS/edit.php?idArray=".$idArray."\">
											<div class=\"form-group\">
												<label>Nombre de Cuartel</label>
												<input class=\"form-control\" name=\"cuartel\" required=\"true\" placeholder=\"Nombre de Cuartel\">
											</div>";
                                        ...
                                        echo    "</select>
											...
											<button type=\"submit\" class=\"btn btn-primary\">Editar Cuartel</button>
