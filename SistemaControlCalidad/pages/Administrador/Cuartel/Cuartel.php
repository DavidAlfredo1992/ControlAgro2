            ...
            <ul class="nav navbar-top-links navbar-right">
                ...
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu dropdown-user">
                        ...
                        <li class="divider"></li>
                        <li><a href="addCuartel.php"><i class="fa fa-plus-circle fa-fw"></i>Agregar Cuartel</a>
                        </li>
                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            Información general de los Sectores
                            ...
                            <div class="dataTable_wrapper">
                                <table width="100%" class="table table-striped table-bordered table-hover" id="dataTables-example">
                                    <thead>
                                        <tr>
                                            <th>#</th>
                                            <th>Nombre de Cuartel</th>
                                            <th>Sector al que Pertenece</th>
                                            <th>Huerto al que Pertenece</th>
                                            <th>Campo al que Pertenece</th>
                                            <th>Det.</th>
                                            <th>Opciones</th>
                                        </tr>
									</thead>
									<tbody>
                                        ...
                                        <?php
											for ($i=1; $i<=$numberUser; $i++){
												...
												echo "<td><a href=\"verDetalles.php?idArray=".$columnas[0]."\" class=\"btn btn-succes btn-circle\"><i class=\"fa fa-fw fa-th-list fa-2x\"></i></a>"."</td>";
												echo "<td>
													<a href=\"editCuartel.php?idArray=".$i."\" class=\"btn btn-warning btn-circle\"><i class=\"fa fa-fw fa-pencil \"></i></a>
													<a href=\"deleteCuartel.php?idArray=".$i."\" class=\"btn btn-danger btn-circle\"><i class=\"fa fa-fw fa-trash-o \"></i></a>";
