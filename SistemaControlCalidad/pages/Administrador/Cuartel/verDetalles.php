                ...
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu dropdown-user">
                        ...
                        <?php
							...
							echo "<li><a href=\"addVariedad.php?campo=".$_GET['idArray']."\"><i class=\"fa fa-plus-circle fa-fw\"></i>Agregar Variedad</a>
							</li>";
						?>
                                        ...
                                        <?php
											for ($i=1; $i<=$numberUser; $i++){
												...
												echo "<td>
													...
													<a href=\"accionesUS/deleteVariedad.php?nombreCampo=".$_GET['idArray']."&variedad=".$i."\" class=\"btn btn-danger btn-circle\"><i class=\"fa fa-fw fa-trash-o \"></i></a>";
