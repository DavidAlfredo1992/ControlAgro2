            ...
            <ul class="nav navbar-top-links navbar-right">
                ...
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu dropdown-user">
                        ...
                        <li class="divider"></li>
                        <li><a href="Temporada.php"><i class="fa fa-sign-out fa-fw"></i>Volver atrás</a>
                        </li>
                                ...
                                <div class="col-lg-6">
                                    <form role="form" method="POST" action="accionesUS/add.php">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" name="temporada" required="true" placeholder="Nombre de la temporada">
                                        </div>
