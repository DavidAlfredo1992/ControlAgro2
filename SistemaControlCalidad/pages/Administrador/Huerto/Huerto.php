            ...
            <ul class="nav navbar-top-links navbar-right">
                ...
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu dropdown-user">
                        ...
                        <li class="divider"></li>
                        <li><a href="addHuerto.php"><i class="fa fa-plus-circle fa-fw"></i>Agregar Huerto</a>
                        </li>
                        <li><a href="Huerto.php"><i class="fa fa-spinner fa-fw"></i>Actualizar</a>
                        </li>
                    </ul>
                    <!-- /.dropdown-user -->
                </li>
                    ...
                    <ul class="nav" id="side-menu">
                        ...
                        <li>
                            ...
                            <ul class="nav nav-second-level">
                                ...
                                <li>
                                    <a href="Huerto.php">Configuración de Huerto</a>
                                </li>
                                <li>
                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            Información general de los Huertos
									...
									<tbody>
                                        ...
                                        <?php
											for ($i=1; $i<=$numberUser; $i++){
												...
												echo "<td>
													<a href=\"editHuerto.php?idArray=".$i."\" class=\"btn btn-warning btn-circle\"><i class=\"fa fa-fw fa-pencil \"></i></a>
													<a href=\"deleteHuerto.php?idArray=".$i."\" class=\"btn btn-danger btn-circle\"><i class=\"fa fa-fw fa-trash-o \"></i></a>";
