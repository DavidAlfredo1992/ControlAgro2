            ...
            <ul class="nav navbar-top-links navbar-right">
                ...
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu dropdown-user">
                        ...
                        <li class="divider"></li>
                        <li><a href="Defecto.php"><i class="fa fa-sign-out fa-fw"></i>Volver atrás</a>
                        </li>
                        ...
                        <li>
                            ...
                            <ul class="nav nav-second-level">
                               <li>
                                ...
                                <li>
                                    <a href="../Importancia/Importancia.html">Configuración de Importancia</a>
                                </li>
                            </ul>
                                ...
                                <div class="col-lg-6">
                                    <form role="form" method="POST" action="accionesUS/add.php">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" name="defecto" required="true" placeholder="Nombre del Defecto">
                                        </div>
