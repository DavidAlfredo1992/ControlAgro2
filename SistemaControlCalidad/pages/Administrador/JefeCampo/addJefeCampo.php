                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            Ingreso de Nuevo Jefe de Campo
                        </div>
                        <div class="panel-body">
                            <div class="row">
                                <div class="col-lg-6">
                                    <form role="form" method="POST" action="accionesUS/addJefe.php">
                                        ...
                                        <button type="submit" class="btn btn-primary">Agregar Jefe de Campo</button>
