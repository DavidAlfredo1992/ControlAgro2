            ...
            <ul class="nav navbar-top-links navbar-right">
                ...
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu dropdown-user">
                        ...
                        <li class="divider"></li>
                        <li><a href="jefeCampo.php"><i class="fa fa-sign-out fa-fw"></i>Volver atrás</a>
                        </li>
                    ...
                    <ul class="nav" id="side-menu">
                        ...
                        <li>
                            ...
                            <ul class="nav nav-second-level">
                                ...
                                <li>
                                    <a href="jefeCampo.php">Configuración de Jefe de Campo</a>
                                </li>
                        ...
                        <div class="panel-body">
                            <div class="row">
                                <div class="col-lg-6">
									...
									<?php
										echo "<form role=\"form\" method=\"POST\" action=\"accionesUS/editJefe.php?idArray=".$idArray."\">
											<div class=\"form-group\">
												<label>Nombre de Jefe de Campo</label>
												<input class=\"form-control\" name=\"nameUser\" required=\"true\" placeholder=\"jefe de campo\">
											</div>
											
											<div class=\"form-group\">
												<label>Seleccione Campo al que Pertence</label>
										...
										echo	"</select>
											...
											<div class=\"form-group\">
												<label>Seleccione Compañía de Teléfono</label>
											...
											<div class=\"form-group\">
												...
												<input class=\"form-control\" name=\"phone\" required=\"true\" placeholder=\"telefono\">
											</div>
											
											<div class=\"form-group\">
												<label>Correo Electrónico</label>
												<input class=\"form-control\" name=\"correo\" required=\"true\" placeholder=\"Correo electrónico\">
											</div>
                                        
											<button type=\"submit\" class=\"btn btn-primary\">Editar Jefe de Campo</button>
