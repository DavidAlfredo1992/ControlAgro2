<?php
	...
	$command = "python ../../../../ControlDeCalidad/Modules/CCUsers/handlerJefeCuadrilla.py 6 ".$jefe;
	$output = array();
	#echo $command;
	exec($command, $output);
            ...
            <ul class="nav navbar-top-links navbar-right">
                ...
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu dropdown-user">
                        ...
                        <?php
							...
							echo "<li><a href=\"addVariedad.php?jefe=".$_GET['idArray']."\"><i class=\"fa fa-plus-circle fa-fw\"></i>Agregar Variedad</a>
							</li>";
						?>
                        <li><a href="Cuartel.php"><i class="fa fa-spinner fa-fw"></i>Actualizar</a>
                        </li>
                    </ul>
                    <!-- /.dropdown-user -->
                </li>
                ...
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu dropdown-user">
                        ...
                        <li class="divider"></li>
                        <li><a href="JefeCuadrilla.php"><i class="fa fa-sign-out fa-fw"></i>Volver atrás</a>
                        </li>
                    ...
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            <?php
								...
								echo "Listado de Variedades supervisadas por: ".$_GET['idArray'];
                            ?>
									...
									<tbody>
                                        ...
                                        <?php
											for ($i=1; $i<=$numberUser; $i++){
												...
												echo "<td>".$columnas[4]."</td>";
												echo "<td>
												
													<a href=\"accionesUS/deleteVariedad.php?campo=".$columnas[0]."&huerto=".$columnas[1]."&sector=".$columnas[2]."&cuartel=".$columnas[3]."&variedad=".$columnas[4]."&jefe=".$_GET['idArray']."\" class=\"btn btn-danger btn-circle\"><i class=\"fa fa-fw fa-trash-o \"></i></a>";
