<?php
	...
	$command = "python ../../../../ControlDeCalidad/Modules/CCUsers/handlerJefeCuadrilla.py 2";
	$output = array();
	#echo $command;
	...
	#huerto
	$command = "python ../../../../ControlDeCalidad/Modules/CCUsers/handlerJefeCuadrilla.py 7";
	$huerto = array();
	#echo $command;
	exec($command, $huerto);#ejecucion del comando
	$numberHuerto = count($huerto);
	
	#sector
	$command = "python ../../../../ControlDeCalidad/Modules/CCUsers/handlerJefeCuadrilla.py 8";
	$sector = array();
	#echo $command;
	exec($command, $sector);#ejecucion del comando
	$numberSector = count($sector);
	
	#cuartel
	$command = "python ../../../../ControlDeCalidad/Modules/CCUsers/handlerJefeCuadrilla.py 9";
	$cuartel = array();
	#echo $command;
	exec($command, $cuartel);#ejecucion del comando
	$numberCuartel = count($cuartel);

	#variedad
	$command = "python ../../../../ControlDeCalidad/Modules/CCUsers/handlerJefeCuadrilla.py 10";
	$variedad = array();
	#echo $command;
	exec($command, $variedad);#ejecucion del comando
	$numberVariedad = count($variedad);
            ...
            <ul class="nav navbar-top-links navbar-right">
                ...
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu dropdown-user">
                        ...
                        <li class="divider"></li>
                        <li><a href="Campo.php"><i class="fa fa-sign-out fa-fw"></i>Volver atrás</a>
                        </li>
                ...
                <div class="sidebar-nav navbar-collapse">
                    <ul class="nav" id="side-menu">
                        ...
                        <li>
                            ...
                            <ul class="nav nav-second-level">
                                <li>
                                    <a href="Campo.php">Configuración de Campo</a>
                                </li>
                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            ...
                            <?php
								echo "Ingreso de Variedades a supervisar para: ".$_GET['jefe'];
                            ?>
                        </div>
                            ...
                            <div class="row">
                                <div class="col-lg-6">
                                    ...
                                    <?php
										...
										echo "<form role=\"form\" method=\"POST\" action=\"accionesUS/addVariedad.php?jefe=".$_GET['jefe']."\">";
                                      ?>
                                         <div class="form-group">
                                            <label>Seleccione el Campo al cual pertence</label>
                                            <select class="form-control" name="campo" required="true">
                                        ...
                                        <div class="form-group">
                                            <label>Seleccione el Huerto al cual pertence</label>
                                            <select class="form-control" name="huerto" required="true">
                                                
                                                <?php
													for ($i=0; $i<$numberHuerto; $i++){
														echo "<option>".$huerto[$i]."</option>";
													}
												?>
                                            </select>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            <label>Seleccione el Sector al cual pertence</label>
                                            <select class="form-control" name="sector" required="true">
                                                
                                                <?php
													for ($i=0; $i<$numberSector; $i++){
														echo "<option>".$sector[$i]."</option>";
													}
												?>
                                            </select>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            <label>Seleccione el Cuartel al cual pertence</label>
                                            <select class="form-control" name="cuartel" required="true">
                                                
                                                <?php
													for ($i=0; $i<$numberCuartel; $i++){
														echo "<option>".$cuartel[$i]."</option>";
													}
												?>
                                            </select>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            <label>Seleccione la Variedad a supervisar</label>
                                            <select class="form-control" name="variedad" required="true">
                                                
                                                <?php
													for ($i=0; $i<$numberVariedad; $i++){
														echo "<option>".$variedad[$i]."</option>";
													}
												?>
                                            </select>
                                        </div>
