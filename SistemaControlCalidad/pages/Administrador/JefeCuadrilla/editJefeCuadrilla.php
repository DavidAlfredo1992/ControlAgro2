                    ...
                    <ul class="nav" id="side-menu">
                        ...
                        <li>
                            ...
                            <ul class="nav nav-second-level">
                                ...
                                <li>
                                    <a href="jefeCuadrilla.php">Configuración de Jefe de Cuadrilla</a>
                                </li>
                            </ul>
                        <li>
									...
									<?php
										echo "<form role=\"form\" method=\"POST\" action=\"accionesUS/editJefe.php?idArray=".$idArray."\">
											<div class=\"form-group\">
												...
												<input class=\"form-control\" name=\"nameUser\" required=\"true\" placeholder=\"jefe de cuadrilla\">
											</div>
											
											<div class=\"form-group\">
												<label>Correo Electrónico</label>
												<input class=\"form-control\" name=\"email\" required=\"true\" placeholder=\"email\">
											</div>
											...
											<button type=\"submit\" class=\"btn btn-primary\">Editar Jefe de Cuadrilla</button>
