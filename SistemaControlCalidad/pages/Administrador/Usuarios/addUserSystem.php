<?php
	...
	$command = "python ../../../../ControlDeCalidad/Modules/CCUsers/manageUser.py 2";
	$output = array();
                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <div class="row">
                                <div class="col-lg-6">
                                    <form role="form" method="POST" action="accionesUS/addUsers.php">
                                        <div class="form-group">
                                            <label>Nombre de Usuario</label>
                                            <input class="form-control" name="nameUser" required="true" placeholder="username">
                                        </div>
                                        <div class="form-group">
                                            <label>Correo Electrónico</label>
                                            <input class="form-control" name="email" required="true" placeholder="username@email">
                                        </div>
                                        
                                        <div class="form-group">
                                            <label>Password</label>
                                            <input class="form-control" type= "password" name="pass" required="true" placeholder="password">
                                        </div>
