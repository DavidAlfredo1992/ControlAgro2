<?php
	...
	#obtenemos la informacion del cliente creado...
	$idUser = $_GET['idUser'];
	#get number of user in data bases
	$command = "python ../../../../ControlDeCalidad/Modules/CCUsers/manageUser.py 6 ".$idUser;
	#echo $command;
	$output = array();
	exec($command, $output);#ejecucion del comando
	$infoUser = explode(";", $output[0]);
	$varClass1 = "<tr class=\"gradeU\">";
	
	$command = "python ../../../../ControlDeCalidad/Modules/CCUsers/handlerJefeCampo.py 2";
	$output = array();
	exec($command, $output);#ejecucion del comando
            ...
            <ul class="nav navbar-top-links navbar-right">
                ...
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu dropdown-user">
                        ...
                        <li class="divider"></li>
                        <li><a href="usersSystem.php"><i class="fa fa-sign-out fa-fw"></i>Volver atrás</a>
                        </li>
                    ...
                    <ul class="nav" id="side-menu">
                        ...
                        <li>
                            ...
                            <ul class="nav nav-second-level">
                                <li>
                                    <a href="usersSystem.php">Configuración de Usuarios Sistema del Sistema</a>
                                </li>
...
-->
		...
		<div id="page-wrapper">
			...
			<div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Información de Cliente</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
			<!-- /.row -->
                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            Resumen de Información actual de cliente
                        </div>
            ...
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Complete Información para el Ingreso de Cliente</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
            <div class="row">
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            Datos Finales para el ingreso de Cliente
                        </div>
                        <div class="panel-body">
                            <div class="row">
                                <div class="col-lg-6">
                                    ...
                                    <?php
										echo "<form role=\"form\" method=\"POST\" action=\"accionesUS/addClienteInfo.php?idUser=".$idUser."\">";
									?>
                                        
                                        <div class="form-group">
                                            <label>Seleccione Campo al que pertenece</label>
                                        ...
                                        <div class="form-group">
                                         ...
                                         <div class="form-group">
                                            ...
                                            <input class="form-control" name="telefono" required="true" placeholder="número telefónico">
                                        </div>
                                        
                                        <button type="submit" class="btn btn-primary">Completar Cliente</button>
                                        <button type="reset" class="btn btn-primary">Vaciar Fomulario</button>
                                    </form>
                                </div>
                            </div>
                            <!-- /.row (nested) -->
