<?php
	...
	$command = "python ../../../../ControlDeCalidad/Modules/CCCuadrillas/handlerSubCuadrillas.py 1";
	$output = array();
            ...
            <ul class="nav navbar-top-links navbar-right">
                ...
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu dropdown-user">
                        ...
                        <li class="divider"></li>
                        <li><a href="addSubCuadrilla.php"><i class="fa fa-plus-circle fa-fw"></i>Agregar SubCuadrilla</a>
                        </li>
                        <li><a href="SubCuadrilla.php"><i class="fa fa-spinner fa-fw"></i>Actualizar</a>
                        </li>
                    </ul>
                    <!-- /.dropdown-user -->
                </li>
                ...
                <div class="sidebar-nav navbar-collapse">
                    <ul class="nav" id="side-menu">
                        ...
                        <li>
                            ...
                            <ul class="nav nav-second-level">
                               <li>
                                    <a href="../Cuadrilla/Cuadrilla.html">Configuración de Cuadrilla</a>
                                </li>

                                <li>
                                    <a href="SubCuadrilla.php">Configuración de SubCuadrilla</a>
                                </li>
                        ...
                        <li>
                            ...
                            <ul class="nav nav-second-level">
                               <li>
                                    <a href="../morris.html">Configuración de Temporada</a>
                                </li>
                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            Información general de SubCuadrillas
									...
									<tbody>
                                        ...
                                        <?php
											for ($i=1; $i<=$numberUser; $i++){
												...
												echo "<td>
													<a href=\"editSubCuadrilla.php?idArray=".$i."\" class=\"btn btn-warning btn-circle\"><i class=\"fa fa-fw fa-pencil \"></i></a>
													<a href=\"deleteSubCuadrilla.php?idArray=".$i."\" class=\"btn btn-danger btn-circle\"><i class=\"fa fa-fw fa-trash-o \"></i></a>";
