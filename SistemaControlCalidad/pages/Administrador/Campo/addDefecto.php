<?php
	...
	$command = "python ../../../../ControlDeCalidad/Modules/CCampos/handlerCampo.py 6";
	$output = array();
	#echo $command;
                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            ...
                            <?php
								echo "Ingreso de Defectos en Campo: ".$_GET['campo'];
                            ?>
                        </div>
                            ...
                            <div class="row">
                                <div class="col-lg-6">
                                    ...
                                    <?php
										...
										echo "<form role=\"form\" method=\"POST\" action=\"accionesUS/addDefectoCampo.php?campo=".$_GET['campo']."\">";
                                      ?>
                                         <div class="form-group">
                                            <label>Selecciona los Defectos para el Campo</label>
                                        ...
                                        <button type="submit" class="btn btn-primary">Agregar Defecto</button>
