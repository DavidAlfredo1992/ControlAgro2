                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            Ingreso de Nuevo Campo
                        </div>
                        <div class="panel-body">
                            <div class="row">
                                <div class="col-lg-6">
                                    <form role="form" method="POST" action="accionesUS/addCampo.php">
                                        <div class="form-group">
                                            <label>Nombre del Campo</label>
                                            <input class="form-control" name="nameCampo" required="true" placeholder="Nombre del Campo">
                                        </div>
                                        
                                         <div class="form-group">
                                            <label>Selecciona los Defectos del Campo</label>
