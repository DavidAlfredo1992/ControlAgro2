<?php
	...
	#obtenemos el listado de defectos asociados a un campo
	$arrayInformation = explode(";", $output[$_GET['idArray']-1]);
	
	$nameCampo = str_replace(" ", "-", $arrayInformation[0]);
	
	#echo $nombreCampo." Es el nombre del campo seleccionado<br>";

	$command = "python ../../../../ControlDeCalidad/Modules/CCampos/handlerCampo.py 7 ".$nameCampo;
	$output = array();
	exec($command, $output);
	$numberUser = count($output);
?>
                ...
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu dropdown-user">
                        ...
                        <?php
							...
							echo "<li><a href=\"addDefecto.php?campo=".$arrayInformation[0]."\"><i class=\"fa fa-plus-circle fa-fw\"></i>Agregar Defecto</a>
							</li>";
						?>
                        <li><a href="Campo.php"><i class="fa fa-spinner fa-fw"></i>Actualizar</a>
                        </li>
                    </ul>
                    <!-- /.dropdown-user -->
                </li>
...
-->
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Sistema de Administración del Servicio</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
                    ...
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            <?php
								...
								echo "Listado de Defectos del Campo: ".$arrayInformation[0];
                            ?>
                                        ...
                                        <?php
											for ($i=1; $i<=$numberUser; $i++){
												...
												echo "<td>
													...
													<a href=\"accionesUS/deleteDefectoCampo.php?nombreCampo=".$arrayInformation[0]."&idArrayDefecto=".$i."\" class=\"btn btn-danger btn-circle\"><i class=\"fa fa-fw fa-trash-o \"></i></a>";
