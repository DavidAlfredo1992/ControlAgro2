            ...
            <ul class="nav navbar-top-links navbar-right">
                ...
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu dropdown-user">
                        ...
                        <li class="divider"></li>
                        <li><a href="addImportancia.php"><i class="fa fa-plus-circle fa-fw"></i>Agregar Importancia</a>
                        </li>
                        <li><a href="Importancia.php"><i class="fa fa-spinner fa-fw"></i>Actualizar</a>
                        </li>
                    </ul>
                    <!-- /.dropdown-user -->
                </li>
                        ...
                        <li>
                            ...
                            <ul class="nav nav-second-level">
                               <li>
                                ...
                                <li>
                                    <a href="Importancia.php">Configuración de Importancia</a>
                                </li>
                            </ul>
									...
									<tbody>
                                        ...
                                        <?php
											for ($i=1; $i<=$numberUser; $i++){
												...
												echo "<td>
													<a href=\"editImportancia.php?idArray=".$i."\" class=\"btn btn-warning btn-circle\"><i class=\"fa fa-fw fa-pencil \"></i></a>
													<a href=\"deleteImportancia.php?idArray=".$i."\" class=\"btn btn-danger btn-circle\"><i class=\"fa fa-fw fa-trash-o \"></i></a>";
