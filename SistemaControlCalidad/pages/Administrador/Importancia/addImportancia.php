            ...
            <ul class="nav navbar-top-links navbar-right">
                ...
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu dropdown-user">
                        ...
                        <li class="divider"></li>
                        <li><a href="Importancia.php"><i class="fa fa-sign-out fa-fw"></i>Volver atrás</a>
                        </li>
                        ...
                        <li>
                            ...
                            <ul class="nav nav-second-level">
                               <li>
                                ...
                                <li>
                                    <a href="Importancia.html">Configuración de Importancia</a>
                                </li>
                            </ul>
                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            Ingreso de Nuevo Tipo de Importancia
                        </div>
                                ...
                                <div class="col-lg-6">
                                    <form role="form" method="POST" action="accionesUS/add.php">
                                        <div class="form-group">
                                            <label>Nombre del Tipo de Importancia</label>
                                            <input class="form-control" name="importancia" required="true" placeholder="Nombre del tipo de importancia">
                                        </div>
