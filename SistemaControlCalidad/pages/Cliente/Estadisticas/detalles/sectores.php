<?php
	...
	$command = "python ../../../../../ControlDeCalidad/Modules/CCStatistics/statisticsCliente.py 7 ".$idCampo;
	$output = array();
	#echo $command;
	exec($command, $output);
...
<body>
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Mis Sectores</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
									...
									<tbody>
                                        ...
                                        <?php
											for ($i=1; $i<=$numberUser; $i++){
												...
												echo "<td><a href=\"estadisticasSectores.php?idCampo=".$idCampo."&sector=".$columnas[0]."&huerto=".$columnas[1]."\" class=\"btn btn-succes btn-circle\"><i class=\"fa fa-fw fa-th-list fa-2x\"></i></a>"."</td>";
												echo "</tr>";
											}
                                        ?>
                                    </tbody>
