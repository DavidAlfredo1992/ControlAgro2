<?php
	...
	$command = "python ../../../../../ControlDeCalidad/Modules/CCStatistics/statisticsCliente.py 19 ".$idCampo. " ".$huerto;
	#echo $command;
	$dataGraphic1 = array();
	...
	$command = "python ../../../../../ControlDeCalidad/Modules/CCStatistics/statisticsCliente.py 20 ".$idCampo. " ".$huerto. " 50";
	$ouput = array();
	#echo $command;
	exec($command, $ouput);
	$controles50 = $ouput[0];
	...
	$command = "python ../../../../../ControlDeCalidad/Modules/CCStatistics/statisticsCliente.py 20 ".$idCampo. " ".$huerto. " 100";
	$ouput = array();
	exec($command, $ouput);
...
<body>
    ...
    <div id="wrapper">
      ...
      <div id="page-wrapper">
            <div class="row">
				<div class="col-lg-12">
					<h1 class="page-header">Controles Efectuados por Huerto</h1>
				</div>
                <!-- /.col-lg-12 -->
            </div>
			<div class="row">
			...
			<div class="row">
				<div class="col-lg-12">
                    <div class="panel panel-default">
                        <div class="panel-heading">
							Defectos Evaluados en controles de calidad por Huerto
						</div>
						<!-- /.panel-heading -->
   ...
   <!-- jQuery -->
    ...
    $('#container').highcharts({
        ...
        title: {
            text: 'Defectos en Controles Encontrados Por Huerto'
        },
        tooltip: {
