<?php
	...
	$command = "python ../../../../../ControlDeCalidad/Modules/CCStatistics/statisticsCliente.py 13 ".$idCampo. " ".$variedad. " 50";
	$dataGraphic1 = array();
	exec($command, $dataGraphic1);
	#$numberUser = count($output);
	
	#controles de muestra 50
	$command = "python ../../../../../ControlDeCalidad/Modules/CCStatistics/statisticsCliente.py 14 ".$idCampo. " ".$variedad. " 50";
	$ouput = array();
	#echo $command;
	exec($command, $ouput);
	$controles50 = $ouput[0];
	...
	$command = "python ../../../../../ControlDeCalidad/Modules/CCStatistics/statisticsCliente.py 14 ".$idCampo. " ".$variedad. " 100";
	$ouput = array();
	exec($command, $ouput);
...
<body>
    ...
    <div id="wrapper">
      ...
      <div id="page-wrapper">
            <div class="row">
				<div class="col-lg-12">
					<h1 class="page-header">Controles Efectuados </h1>
				</div>
                <!-- /.col-lg-12 -->
            </div>
			<div class="row">
			...
			<div class="row">
				<div class="col-lg-12">
                    <div class="panel panel-default">
                        <div class="panel-heading">
							Defectos Evaluados en controles de calidad
						</div>
						<!-- /.panel-heading -->
   ...
   <!-- jQuery -->
    ...
    $('#container').highcharts({
        ...
        title: {
            text: 'Defectos en Controles Encontrados'
        },
        tooltip: {
