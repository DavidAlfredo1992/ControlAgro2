<?php
	...
	$idCampo = $_GET['idCampo'];
	$command = "python ../../../../ControlDeCalidad/Modules/CCStatistics/statisticsCliente.py 12 ".$idCampo;
	$output = array();
	#echo $command;
	exec($command, $output);
...
<body>
    ...
    <div id="wrapper">
       ...
       <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Mis Controles</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            Listado de Controles Generados
									...
									<tbody>
                                        ...
                                        <?php
											for ($i=1; $i<=$numberUser; $i++){
												...
												echo "<td>".$columnas[5]."</td>";												
												echo "<td><a href=\"resumenPlanilla.php?idCampo=".$idCampo."&idControl=".$columnas[0]."&idPlanilla=".$columnas[1]."\" class=\"btn btn-succes btn-circle\"><i class=\"fa fa-fw fa-th-list fa-2x\"></i></a>"."</td>";
