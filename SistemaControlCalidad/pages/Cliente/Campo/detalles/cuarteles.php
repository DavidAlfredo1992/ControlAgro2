<?php
	...
	$command = "python ../../../../../ControlDeCalidad/Modules/CCStatistics/statisticsCliente.py 8 ".$idCampo;
	$output = array();
	#echo $command;
	exec($command, $output);
...
<body>
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Mis Cuarteles</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            Listado de Cuarteles existentes
