<?php
	...
	#debemos obtener los Huertos del campo seleccionado
	$campo = $_POST['campo'];
	$campo = str_replace(" ", "-", $campo);
	$command = "python ../../../../ControlDeCalidad/Modules/CCPlanillas/handlerPlanilla.py 2 ".$campo;
	$huertos = array();
	exec($command, $huertos);#ejecucion del comando
	$numberHuertos = count($huertos);
                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <div class="row">
                                <div class="col-lg-6">
                                    <?php
                                    echo "<form role=\"form\" method=\"POST\" action=\"etapa3.php?campo=".$_POST['campo']."\">";
										?>
										<fieldset disabled>
										...
										<div class="form-group">
                                            <label>Seleccione Huerto</label>
                                            <select class="form-control" name="huerto" required=true>
												<?php
													for ($i=0; $i<$numberHuertos; $i++){
														echo "<option>".$huertos[$i]."</option>";
													}
												?>
                                        ...
                                        <button type="submit" class="btn btn-primary">Agregar Huerto</button>
