<?php
	...
	$command = "python ../../../../ControlDeCalidad/Modules/CCPlanillas/handlerPlanilla.py 10 ".$campo." ".$huerto." ".$sector." ".$cuartel." ".$variedad." ".$temporada." ".$jefeCuadrilla." ".$cuadrilla." ".$ListaDefectos;
	#echo $command;
	$output = array();
	exec($command, $output);
	...
	#echo $command;
	$defectosImportancia = array();
	exec($command, $defectosImportancia);
	#echo $command;
	$numberDefectos = count($defectosImportancia);
						...
						<div class="panel-body">
                            <div class="row">
                                <div class="col-lg-6">
									...
									<?php
										echo "<form role=\"form\" method=\"POST\" action=\"editar.php?campo=".$_GET['campo']."&huerto=".$_GET['huerto']."&sector=".$_GET['sector']."&cuartel=".$_GET['cuartel']."&variedad=".$_GET['variedad']."&jefeCuadrilla=".$_GET['jefeCuadrilla']."&cuadrilla=".$_GET['cuadrilla']."&temporada=".$_GET['temporada']."&idPlanilla=".$idPlanilla."\">";
									?>	
                                        <div class="form-group">
                                            <label>Seleccione Los Defectos del Campo a Utilizar con Importancia Menor</label>
                                             <p class="help-block">Pulsando la tecla control puedes seleccionar más de uno</p>
                                             <p class="help-block">Por defecto la configuración de la importancia es MAYOR</p>
                                             <p class="help-block">Puede no seleccionar ninguna opción</p>
                                            <select multiple class="form-control" name="menores[]">
												<?php
