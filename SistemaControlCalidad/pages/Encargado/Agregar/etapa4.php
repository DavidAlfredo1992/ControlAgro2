<?php
	...
	$command = "python ../../../../ControlDeCalidad/Modules/CCPlanillas/handlerPlanilla.py 4 ".$campo." ".$huerto." ".$sector;
	
	#echo $command;
	$cuarteles = array();
	exec($command, $cuarteles);#ejecucion del comando
	$numberCuarteles = count($cuarteles);
                        ...
                        <div class="panel-body">
                            <div class="row">
                                <div class="col-lg-6">
									...
									<?php
										echo "<form role=\"form\" method=\"POST\" action=\"etapa5.php?campo=".$_GET['campo']."&huerto=".$_GET['huerto']."&sector=".$_POST['sector']."\">";
									?>	
										<fieldset disabled>
										...
										<div class="form-group">
                                            <label>Seleccione Cuartel</label>
                                            <select class="form-control" name="cuartel" required=true>
												<?php
													for ($i=0; $i<$numberCuarteles; $i++){
														echo "<option>".$cuarteles[$i]."</option>";
													}
												?>
