<?php
	...
	$command = "python ../../../../ControlDeCalidad/Modules/CCPlanillas/handlerPlanilla.py 8";
	
	#echo $command;
	$temporadas = array();
	exec($command, $temporadas);#ejecucion del comando
	$numberTemporadas = count($temporadas);
         ...
         <div class="navbar-default sidebar" role="navigation">
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            Generación de Nueva Plantilla: Recolección de Información de Temporada
                        </div>
                        <div class="panel-body">
                            <div class="row">
                                <div class="col-lg-6">
									...
									<?php
										echo "<form role=\"form\" method=\"POST\" action=\"etapa8.php?campo=".$_GET['campo']."&huerto=".$_GET['huerto']."&sector=".$_GET['sector']."&cuartel=".$_GET['cuartel']."&variedad=".$_GET['variedad']."&jefeCuadrilla=".$_GET['jefeCuadrilla']."&cuadrilla=".$_POST['cuadrilla']."\">";
									?>	
										
										<div class="form-group">
                                            <label>Seleccione Temporada</label>
                                            <select class="form-control" name="temporada" required=true>
												<?php
													for ($i=0; $i<$numberTemporadas; $i++){
														echo "<option>".$temporadas[$i]."</option>";
													}
												?>
