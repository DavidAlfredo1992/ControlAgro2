<?php
	...
	$command = "python ../../../../ControlDeCalidad/Modules/CCPlanillas/handlerPlanilla.py 1";
	$campos = array();
	exec($command, $campos);#ejecucion del comando
	$numberCampos = count($campos);
                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <div class="row">
                                <div class="col-lg-6">
                                    <form role="form" method="POST" action="etapa2.php">
										<div class="form-group">
                                            <label>Seleccione Campo</label>
                                            <select class="form-control" name="campo" required=true>
												<?php
													for ($i=0; $i<$numberCampos; $i++){
														echo "<option>".$campos[$i]."</option>";
													}
												?>
