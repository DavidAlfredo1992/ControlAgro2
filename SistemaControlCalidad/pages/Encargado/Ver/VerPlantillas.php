<?php
	...
	$command = "python ../../../../ControlDeCalidad/Modules/CCPlanillas/handlerPlanilla.py 16";
	#echo $command;
	$output = array();
	exec($command, $output);#ejecucion del comando
	$numberPlanillas = count($output);
...
<!-- Navigation -->
         ...
         <div class="navbar-default sidebar" role="navigation">
                <div class="sidebar-nav navbar-collapse">
                    <ul class="nav" id="side-menu">
                        ...
                        <li>
                            <a href="testEmail.php"><i class="fa fa-fw fa-fw fa-5x fa-home fa-fw"></i>Test Correo</a>
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Visualización de Plantillas Generadas</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            Información general de las Plantillas Generadas
                            ...
                            <div class="dataTable_wrapper">
                                <table width="100%" class="table table-striped table-bordered table-hover" id="dataTables-example">
									...
									<tbody>
                                        ...
                                        <?php
											for ($i=1; $i<=$numberPlanillas; $i++){
												
												echo $varClass1;
												$columnas = explode(";", $output[$i-1]);
												echo "<td>".$i."</td>";
												echo "<td>".$columnas[1]."</td>";
												echo "<td><a href=\"verDetalles.php?idPlanilla=".$columnas[0]."\" class=\"btn btn-succes btn-circle\"><i class=\"fa fa-fw fa-th-list fa-2x\"></i></a>"."</td>";
												echo "</tr>";
											}
                                        ?>
                                    </tbody>
